...
namespace GamemodesServer.Gamemodes.Scooterball
{
    ...
    public abstract class Scooterball_Map : GamemodeBaseMap
    {
        ...
        /// </summary>
        public Vector3 BallSpawnPos { get; protected set; } = Vector3.Zero;

        /// <summary>
        /// Position 1 of red goal
        /// </summary>
        public Vector3 RedGoalPos1 { get; protected set; } = Vector3.Zero;

        /// <summary>
        /// Position 2 of red goal
        /// </summary>
        public Vector3 RedGoalPos2 { get; protected set; } = Vector3.Zero;

        /// <summary>
        /// Position 1 of blue goal
        /// </summary>
        public Vector3 BlueGoalPos1 { get; protected set; } = Vector3.Zero;

        /// <summary>
        /// Position 2 of blue goal
        /// </summary>
        public Vector3 BlueGoalPos2 { get; protected set; } = Vector3.Zero;
        ...
        /// </summary>
        public Vector3 Boundary1 { get; protected set; } = Vector3.Zero;

        /// <summary>
        /// Map Boundary Position 2
        /// </summary>
        public Vector3 Boundary2 { get; protected set; } = Vector3.Zero;
    }
}
